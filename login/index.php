...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta name="author" content="DarkPersist">
            ...
            <div class="form signinForm">
                <form action="index.php" method="post">
                    ...
                    <div class="icon emailIn">
                        <input id="emailIn" onblur="verifyEmailIn()" type="email" name="email" placeholder=' Correo' maxlength="120" value="<?php if(!empty($_POST['email'])){ echo($_POST['email']); }?>" required>
            ...
            <div class="form signupForm">
                <form action="index.php" method="post">
                    ...
                    <div class="icon nameUp">
                        <input id="nameUp" type="text" onblur="verifyNameUp()" name="name" placeholder=" Nombre Y Apellido(s)" maxlength="50" value="<?php if(!empty($_POST['name'])){ echo($_POST['name']); }?>" required>
                        <i id="success" class="fas fa-check-circle"></i><i id="error" class="fas fa-exclamation-circle"></i><i id="warning" class="fas fa-exclamation-triangle"></i>
                    </div>
                    <div class="icon emailUp">
                        <input id="emailUp" onblur="verifyEmailUp()" type="email" name="email" placeholder=" Correo" maxlength="120" value="<?php if(!empty($_POST['email'])){ echo($_POST['email']); }?>" required>
                        <i id="success" class="fas fa-check-circle"></i><i id="error" class="fas fa-exclamation-circle"></i><i id="warning" class="fas fa-exclamation-triangle"></i>
                    </div>
